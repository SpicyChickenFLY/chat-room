...
def get_room_details_for_user(user_id: int):
    ...
    result = (
        db.session.query(
            ...
            new_msg_count_and_latest_chat.c.new_msg_count,
            new_msg_count_and_latest_chat.c.latest_chat_id,
            new_msg_count_and_latest_chat.c.latest_chat_content,
            new_msg_count_and_latest_chat.c.latest_chat_create_time
        ).outerjoin(
            new_msg_count_and_latest_chat,
            Room.id == new_msg_count_and_latest_chat.c.room_id,
        )
    ).all()
